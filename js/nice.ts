...
minus.addEventListener("click", function () {
  ...
  /** @type {number} */
  node.innerText = (current - 1).toString();
}),
  ...
  heart.addEventListener("click", function () {
    ...
    if (
      ...
      (child = document.createElement("li")).setAttribute("data-num", m.toString());
      /** @type {string} */
  ...
  pause.addEventListener("click", function () {
    ...
    []
      .concat(toConsumableArray(document.getElementsByTagName("button")))
